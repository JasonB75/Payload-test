...
class serialPlot:
    def __init__(self, serialPort = '/dev/ttyUSB0', serialBaud = 9600, plotLength = 500, dataNumBytes = 4, numPlots=5):
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText, pltNumber):
        ...
        alue,  = struct.unpack(self.dataType, data) # we get the latest data point and append it to our array
...
def main():
    ...
    style = ['r-', 'g-', 'b-', 'b-', 'b-', 'b-']    # linestyles for the different plots
    anim = []
