...
class serialPlot:
    def __init__(self, serialPort='/dev/ttyUSB0', serialBaud=9600, plotLength=200, dataNumBytes=2, numPlots=4):
...
def main():
    ...
    s.readSerialStart()                                               # starts background thread PLay Freebird
 
    # plotting starts below
    pltInterval = 100    # Period at which the plot animation updates [ms]
    lineLabelText = ['Temp', 'Pressure', 'Humidity', 'Crosswinds']
    title = ['Temp', 'Air Pressure', 'Humidity', 'Crosswinds']
    xLimit = [(0, maxPlotLength), (0, maxPlotLength), (0, maxPlotLength), (0, maxPlotLength)]
    yLimit = [(0, 50), (950, 1050), (0, 100), (0, 50)]
